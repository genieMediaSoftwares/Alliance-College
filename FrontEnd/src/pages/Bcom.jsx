  ...
  "Year 2": [
    {
      ...
      subjects: [
        ...
        "Business Law (Contract & Sale of Goods Act)",
        "Cost Accounting",
      ],
    },
    {
...
function PlacementAndTestimonials() {
  ...
  const testimonials = [
    {
      text: "The B.Com curriculum here gave me a strong grip on taxation and GST from Year 2 itself. By the time I graduated, I had practical experience in Tally and ITR filing — things most freshers learn on the job. I was placed at Deloitte before my final exams.",
      name: "Kavya Reddy",
