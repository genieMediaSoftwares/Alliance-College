...
const terms = [
  {
    ...
    body: "By accessing and using the website of Alliance Degree College, you agree to comply with and be bound by these Terms and Conditions.",
  },
  {
    icon: User,
    title: "2. Use of Website",
    body: "You agree to use our website and services only for lawful purposes and in a way that does not infringe the rights of or restrict the use and enjoyment of this site by any third party.",
  },
  {
    icon: ShieldCheck,
    title: "3. Intellectual Property",
    body: "All content on this website, including text, graphics, logos, images, and design, is the property of Alliance Degree College and is protected by intellectual property laws.",
  },
  {
    icon: CreditCard,
    title: "4. Admissions and Fees",
    body: "All admissions are subject to eligibility criteria. Fees once paid are non-refundable except as per the college refund policy.",
  },
  {
    icon: ClipboardList,
    title: "5. Student Responsibilities",
    body: "Students are expected to maintain discipline, attend classes regularly, and adhere to the rules and regulations of the college.",
  },
  {
    icon: AlertCircle,
    title: "6. Limitation of Liability",
    body: "Alliance Degree College shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use our website or services.",
  },
  {
    icon: RefreshCw,
    title: "7. Changes to Terms",
    body: "We reserve the right to update or modify these Terms and Conditions at any time. Changes will be posted on this page with the updated effective date.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-1">
        <div className="rounded-xl shadow-xl border border-gray-100 grid grid-cols-2 sm:grid-cols-4 gap-0 overflow-hidden bg-white">
          {stats.map(({ icon: Icon, value, label }, i) => (
            <div
              key={i}
              className={`flex items-center gap-3 sm:gap-4 px-5 py-5 sm:py-6
            ...
            >
              ...
              <div>
                <p
                  ...
                  style={{ color: NAVY, fontSize: "clamp(1.1rem, 3vw, 1.45rem)" }}
                >
                  {value}
                </p>
