        ...
        <div className="flex flex-col lg:flex-row items-center min-h-[390px] lg:min-h-[410px] py-10 lg:py-0">
          <div className="flex-1 text-white pt-4 lg:pt-0 text-center lg:text-left lg:max-w-[58%]">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              <button className="px-7 py-2.5 font-bold rounded transition-all hover:brightness-110 active:scale-95 shadow-lg"
                style={{ background: GOLD, color: "#fff", fontSize: "0.9rem" }}>
                Apply Now
              </button>
              <button className="px-6 py-2.5 font-semibold rounded border-2 border-white text-white flex items-center gap-2 transition-all hover:bg-white hover:text-[#0F2B5B] active:scale-95"
...
function GalleryCard({ label, img }) {
  return (
    <div className="flex flex-col gap-2">
      <div className="rounded-xl overflow-hidden bg-gray-100 group" style={{ aspectRatio: "4/3" }}>
  ...
  return (
    <section className="py-14 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop: all 5 equal columns */}
        <div className="hidden lg:flex items-center gap-4">
          <button onClick={prev} disabled={startIdx === 0}
        ...
        <div className="hidden sm:flex lg:hidden items-center gap-4">
          ...
          <button onClick={() => next(tabletVisible)} disabled={startIdx >= galleryItems.length - tabletVisible}
            className="w-9 h-9 rounded-full border border-gray-200 bg-white flex items-center justify-center flex-shrink-0 hover:bg-gray-50 disabled:opacity-30 transition-all shadow-sm">
            <ChevronRight size={18} color="#374151"/>
          </button>
        </div>
              ...
              <div className="flex gap-2 justify-center sm:justify-start mt-5">
                {testimonials.map((_, i) => (
                  <button key={i} onClick={() => setIdx(i)}
                    ...
                    style={{ width: i === idx ? "20px" : "8px", height: "8px",
