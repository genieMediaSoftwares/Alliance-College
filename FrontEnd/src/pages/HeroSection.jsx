import { FaUserGraduate,FaDownload,FaUniversity,FaChalkboardTeacher,FaHandshake,FaGraduationCap,FaUsers,FaChartLine,FaTrophy,} from "react-icons/fa";
    ...
    return (
        <section className="relative w-full min-h-[220px] sm:min-h-[420px] md:min-h-[400px] bg-gradient-to-r from-white via-blue-50 to-blue-100 overflow-visible font-sans pb-24 sm:pb-28 md:pb-28">
            <div className="absolute inset-0">
                <div className="absolute top-0 right-0 w-full md:w-[58%] h-full bg-cover bg-center" style={{ backgroundImage: "url('https://alliancemgt.org/Alliance%20Images/herosec.png')",}}/>
        ...
        &amp;
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8 justify-center md:justify-start">
                        ...
                        <a    href="/Brochure.pdf" download="Brochure.pdf" className="flex items-center gap-2 bg-white hover:bg-gray-50 text-[#1a2e6e] font-semibold border border-gray-300 px-5 sm:px-6 py-2.5 sm:py-3 rounded-md text-sm shadow-sm transition-colors duration-200 no-underline" >
            ...
            <div className="absolute bottom-[-40px] md:bottom-[-60px] left-0 right-0 flex justify-center md:justify-end pb-4 sm:pb-6 z-20 px-3 md:px-10">
                <div className=" bg-[#1a2e6e] rounded-lg sm:rounded-xl px-3 py-2 grid grid-cols-4 gap-2 sm:gap-3 w-full sm:w-[85%] md:w-[70%] lg:w-[60%] max-w-3xl shadow-xl">
                    {stats.map((s, i) => (
