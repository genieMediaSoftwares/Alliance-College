...
import {Clock, Briefcase,GraduationCap,Users,Download,ChevronDown,ChevronLeft,ChevronRight,Star,Building2,Award,Globe,ShieldCheck,UserCheck,TrendingUp,BadgePercent,Code2, Database,Monitor,Cpu,Cloud,Network,BrainCircuit,LayoutDashboard, Smartphone, BookOpen,Layers,} from "lucide-react";
...
function Hero() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ minHeight: 390 }}>
      <img src="https://alliancemgt.org/Alliance%20Images/bcabg.jpg" alt="BCA Computer Applications" className="absolute inset-0 w-full h-full object-cover object-center" />
      ...
      <div className="absolute right-0 bottom-0 h-full hidden lg:block" style={{ width: "40%" }}>
        <img src="https://alliancemgt.org/Alliance%20Images/bcabg1.jpg" alt="BCA Student" className="h-full w-full object-cover object-top" style={{ maskImage: "linear-gradient(to right,transparent 0%,black 28%)", WebkitMaskImage: "linear-gradient(to right,transparent 0%,black 28%)",}}/>
      </div>
...
const curriculum = {
  "Year 1": [
    {sem: "Semester 1",
      subjects: [ "Fundamentals of Computer Science", "Programming in C","Mathematics for Computing", "Digital Electronics & Computer Organisation",],
    },
    {
      sem: "Semester 2",
      subjects: ["Object-Oriented Programming with C++", "Data Structures","Database Management Systems (DBMS)","Web Technology Fundamentals (HTML & CSS)",],
    },
  ],
  "Year 2": [
    {
      sem: "Semester 3",
      subjects: ["Java Programming","Operating Systems","Computer Networks","Software Engineering",],
    },
    {
      sem: "Semester 4",
      subjects: ["Python Programming","Advanced DBMS & SQL","Web Development (JavaScript & React Basics)","Computer Graphics", ],
    },
  ],
  "Year 3": [
    {
      sem: "Semester 5",
      subjects: [ "Full Stack Web Development","Cloud Computing & DevOps Basics","Artificial Intelligence & Machine Learning","Mobile Application Development",],
    },
    {
      sem: "Semester 6",
      subjects: [ "Industry Internship (Compulsory)","Cybersecurity Fundamentals","Project Work & Research", "Viva Voce & Project Defence",],
    },
  ],
};
function Curriculum() {
...
function PlacementAndTestimonials() {
  ...
  const testimonials = [
    {text: "The BCA programme gave me a rock-solid foundation in Java, Python, and web development. The project studio and live internship made me industry-ready before I even graduated. I was placed at TCS in my final year.",name: "Aditya Sharma",batch: "BCA Batch 2023",role: "Software Engineer, TCS Hyderabad",photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
    {text: "The AI & ML module in Year 3 was a game changer. I built a real machine learning project that became part of my portfolio. I received two offers before my final semester ended.",name: "Preethi Suresh",batch: "BCA Batch 2023",role: "Junior Data Analyst, Infosys Vizag",photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
    {text: "I came in with zero coding experience. By the end of Year 1, I was building full websites. The faculty and lab infrastructure here are genuinely world-class. Highly recommend BCA to anyone passionate about tech.",name: "Rohan Nair",batch: "BCA Batch 2022",role: "Full Stack Developer, Wipro Chennai",photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
  ];
  return (
    <section style={{ background: LIGHT_BG }} className="py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-7 shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold" style={{ color: NAV_BLUE, fontSize: "1.05rem" }} >
              ...
              <div className="flex items-center gap-3">
                <img src={testimonials[idx].photo} alt={testimonials[idx].name} className="w-12 h-12 rounded-full object-cover flex-shrink-0 border-2 border-blue-100"/>
                <div>
                  ...
                  <p className="font-medium"  style={{ color: ICON_BLUE, fontSize: "0.76rem" }}>
            ...
            <div className="flex items-center justify-between mt-5">
              <div className="flex gap-1.5">
                {testimonials.map((_, i) => (
                  <button key={i} onClick={() => setIdx(i)}  className="w-2 h-2 rounded-full transition-all" style={{ background: i === idx ? NAV_BLUE : "#d1d5db" }}/> ))}
              </div>
              <div className="flex gap-2">
                <button onClick={() => setIdx( (p) => (p - 1 + testimonials.length) % testimonials.length ) } className="p-1.5 rounded-full border border-gray-200 hover:bg-gray-50">
                  <ChevronLeft size={13} color="#6b7280" />
                </button>
                <button onClick={() => setIdx((p) => (p + 1) % testimonials.length)} className="p-1.5 rounded-full border border-gray-200 hover:bg-gray-50" >
...
const faqs = [
  { q: "What is the eligibility for BCA?",a: "Candidates must have completed 10+2 in any stream (Science, Commerce, or Arts) with a minimum of 50% marks from a recognised board. Mathematics at 10+2 level is preferred but not mandatory at all institutions.",},
  {q: "Is BCA equivalent to a B.Tech / B.E. in Computer Science?",a: "BCA and B.Tech/B.E. are both undergraduate degrees in the IT/CS domain. BCA is a 3-year programme focused on applications and software development, while B.Tech is a 4-year engineering degree. BCA graduates are equally sought after in the software industry and are eligible for MCA, MBA, and M.Sc. programmes for further study.",},
  {q: "What programming languages will I learn in BCA?",a: "The BCA curriculum covers C, C++, Java, Python, JavaScript, and web technologies such as HTML, CSS, and React basics. You will also work with SQL databases and get exposure to cloud platforms like AWS and Azure in the final year.",},
  {q: "Is hostel facility available?",a: "Yes, the college provides separate hostel facilities for boys and girls with all basic amenities including food, Wi-Fi, and 24-hour security.",},
  {q: "Does the BCA include an internship?", a: "Yes, Semester 6 includes a compulsory industry internship with IT companies and tech partners. Students also complete a major project and present it during the Viva Voce for final evaluation.",},
  {q: "What are the career opportunities after BCA?",a: "BCA graduates can pursue roles such as Software Developer, Web Developer, Full Stack Developer, Data Analyst, System Administrator, Network Engineer, and IT Support Specialist. They can also pursue MCA, MBA (IT), or M.Sc. (Computer Science) for higher education.",},
];
