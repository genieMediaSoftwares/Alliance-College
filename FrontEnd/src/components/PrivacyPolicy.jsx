import {Shield,FolderOpen,Lock,User,FileText, Mail,GraduationCap, Users,TrendingUp, Trophy, Phone,ChevronRight,Image,} from "lucide-react";
const NAVY = "#0A1F44";
const GOLD = "#F5A623";
const policies = [
  {icon: Shield,title: "1. Information We Collect", body: "We collect personal information that you provide to us, such as your name, email address, phone number, and academic details when you fill out forms or contact us.",},
  {icon: FolderOpen,title: "2. How We Use Your Information",body: "We use your information to provide and improve our services, communicate with you, process applications, and send important updates related to our programs and events.",},
  {icon: Lock,title: "3. Data Security",body: "We implement appropriate security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction.",},
  {icon: User,title: "4. Your Rights",body: "You have the right to access, update, or delete your personal information. You may also opt out of marketing communications at any time.",},
  {icon: FileText,title: "5. Changes to This Policy",body: "We may update this Privacy Policy from time to time. Any changes will be posted on this page with the updated effective date.",},
];
const galleryImages = [
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <section className="relative min-h-[320px] sm:min-h-[380px] flex items-end pb-0 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(90deg, rgba(10,31,68,0.92) 0%, rgba(10,31,68,0.75) 45%, rgba(10,31,68,0.25) 100%)",}} />
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <h1 className="font-extrabold text-white leading-tight mb-3" style={{ fontSize: "clamp(2rem, 5vw, 3rem)" }} >
            Privacy Policy
          </h1>
          ...
          <div className="flex items-start gap-4 sm:gap-6 rounded-xl p-5 sm:p-6" style={{ background: "#F0F4FF" }}>
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                ...
                or call us at{" "}
                <a href="tel:8885066502" className="text-gray-700 font-medium">
                8885066502
                </a>
                .
              </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          {galleryImages.map((img, i) => (
            <div key={i} className={`overflow-hidden rounded-xl group cursor-pointer ${ i === 0 ? "col-span-2 sm:col-span-1 row-span-1" : "" }`}>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-10 max-w-6xl mx-auto">
        <div className="rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6 px-6 sm:px-10 py-8 sm:py-10" style={{ background: NAVY }}>
          <div className="flex items-center gap-5">
            ...
            <div>
              <h3 className="font-bold text-white mb-1" style={{ fontSize: "clamp(1.1rem, 2.5vw, 1.35rem)" }}>
