      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center min-h-[380px] lg:min-h-[400px] py-10 lg:py-0">
          <div className="flex-1 text-white pt-4 lg:pt-0 text-center lg:text-left lg:max-w-[58%]">
            ...
            <h1 className="font-extrabold text-white leading-none mb-1" style={{ fontSize: "clamp(2.8rem, 6vw, 4.5rem)" }} >
              BBA(Hons)
            </h1>
...
const curriculum = {
  "Year 1": [
    {sem: "Semester 1",subjects: ["Business Communication", "Principles of Management", "Financial Accounting", "Business Mathematics"],},
    { sem: "Semester 2",subjects: ["Organizational Behavior", "Business Law", "Cost Accounting", "Business Economics"], },
  ],
  "Year 2": [
    {sem: "Semester 3",subjects: ["Marketing Management", "Human Resource Management", "Entrepreneurship Development", "Statistics for Business"],},
    {sem: "Semester 4",subjects: ["Corporate Accounting", "E-Commerce", "Research Methodology", "Business Environment"],},
  ],
  "Year 3": [
    {sem: "Semester 5",subjects: ["International Business", "Investment Management", "Supply Chain Management", "Project Work"],},
    { sem: "Semester 6",subjects: ["Strategic Management", "Retail Management", "Management Information Systems", "Project Work & Viva"],},
  ],
};
function Curriculum() {
...
function CareerWhyTestimonials() {
  ...
  const testimonials = [
    {text: "BBA at Alliance helped me discover my passion for business and leadership.",name: "Neha Kumari",batch: "BBA Batch 2023", photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
    { text: "The practical approach and internship support gave me a strong head start in my career.", name: "Siddharth Rao", batch: "BBA Batch 2022",photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
    {text: "Alliance's faculty and industry exposure shaped me into a confident professional.",name: "Divya Reddy",batch: "BBA Batch 2023",photo: "https://alliancemgt.org/Alliance%20Images/test.jpg",},
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
            ...
            <button className="w-full py-2.5 rounded-lg font-semibold text-white transition-all hover:brightness-110 active:scale-95" style={{ background: NAV_BLUE, fontSize: "0.85rem" }}>
            ...
            <div className="flex items-center justify-between mt-5">
              <div className="flex gap-1.5">
                {testimonials.map((_, i) => (
                  <button key={i} onClick={() => setTestimonialIdx(i)} className="w-2 h-2 rounded-full transition-all" style={{ background: i === testimonialIdx ? NAV_BLUE : "#d1d5db" }} />
                ))}
              </div>
              <div className="flex gap-2">
                <button onClick={() => setTestimonialIdx((p) => (p - 1 + testimonials.length) % testimonials.length)} className="p-1.5 rounded-full border border-gray-200 hover:bg-gray-50">
                  <ChevronLeft size={13} color="#6b7280" />
                </button>
                <button onClick={() => setTestimonialIdx((p) => (p + 1) % testimonials.length)} className="p-1.5 rounded-full border border-gray-200 hover:bg-gray-50">
...
const galleryItems = [
  {label: "Classroom Learning",img: "https://alliancemgt.org/Alliance%20Images/Img24.jpeg",},
  {label: "Group Discussions",img: "https://alliancemgt.org/Alliance%20Images/Img31.jpeg",},
  {label: "Campus Activities",img: "https://alliancemgt.org/Alliance%20Images/foodproductionlab.jpg",},
  {label: "Industrial Visit",img: "https://alliancemgt.org/Alliance%20Images/Img30.jpeg",},
  {label: "Seminars & Workshops",img: "https://alliancemgt.org/Alliance%20Images/Img48.jpeg",},
];
...
const faqs = [
  {q: "What is the eligibility for BBA?",a: "Candidates must have completed 10+2 in any stream with a minimum of 50% marks from a recognized board.",},
  {q: "What are the career opportunities after BBA?",a: "BBA graduates can pursue careers as Business Executives, Marketing Managers, Entrepreneurs, Sales Managers, HR Assistants, and more.",},
  { q: "Does the college provide placement support?", a: "Absolutely. Our dedicated placement cell provides 100% placement assistance, organizing campus drives with 100+ recruiting companies.",},
  { q: "What are the internship opportunities?", a: "Students are placed in internships with industry partners during the program. Our strong corporate network ensures diverse and relevant internship placements.",},
{q: "What is the fee structure for BBA?",a: "Please download the brochure or contact our admissions office for detailed information on fees, scholarships, and financial aid options.",},
];
